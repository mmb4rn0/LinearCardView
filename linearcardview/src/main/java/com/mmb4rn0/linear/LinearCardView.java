...
public class LinearCardView extends LinearLayout {
    ...
    private static final LinearCardImpl IMPL;

    static {
        if (Build.VERSION.SDK_INT >= 21) {
            IMPL = new LinearCardViewApi21Impl();
        } else {
            IMPL = new LinearCardViewApi17Impl();
        }
        IMPL.initStatic();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (!(IMPL instanceof LinearCardViewApi21Impl)) {
    ...
    private final LinearCardViewDelegate mCardViewDelegate = new LinearCardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return LinearCardView.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return LinearCardView.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            LinearCardView.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                LinearCardView.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                LinearCardView.super.setMinimumHeight(height);
            }
        }
